    ...
    <div className={"flex flex-row w-full justify-between"}>
      <div>
        ...
        <button
          ...
          className="inline-block ml-4 px-6 py-2.5 bg-purple-600 text-white font-medium text-md leading-tight rounded-2xl shadow-md hover:bg-slate-600 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
        ...
        {visible && (
          <div
            className="fixed z-40 overflow-y-auto top-0 w-full left-0 bg-purple-500"
            id="modal"
          >
              ...
              <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                >
                  ...
                  <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4"> 
                    <div className="text-2xl font-bold text-purple-700 mb-4">Add a product to the marketplace</div>
                    ...
                    />
                    <div className="font-mono"><span className="text-red-700">*</span>Note: Creating a product automatically gives the product a 5 star rating</div>
                  </div>
